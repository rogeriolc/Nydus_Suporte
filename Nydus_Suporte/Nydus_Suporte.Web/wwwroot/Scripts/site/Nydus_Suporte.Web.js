...
(function (Nydus_Suporte) {
    ...
    })(Administration = Nydus_Suporte.Administration || (Nydus_Suporte.Administration = {}));
...
(function (Nydus_Suporte) {
    ...
    })(BasicSamples = Nydus_Suporte.BasicSamples || (Nydus_Suporte.BasicSamples = {}));
})(Nydus_Suporte || (Nydus_Suporte = {}));
var Nydus_Suporte;
(function (Nydus_Suporte) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Nydus_Suporte.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Nydus_Suporte.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Nydus_Suporte.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (Nydus_Suporte) {
    ...
    })(Northwind = Nydus_Suporte.Northwind || (Nydus_Suporte.Northwind = {}));
})(Nydus_Suporte || (Nydus_Suporte = {}));
var Nydus_Suporte;
(function (Nydus_Suporte) {
    var Northwind;
...
(function (Nydus_Suporte) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Nydus_Suporte.Northwind.Gender', 'Nydus_Suporte.Northwind.Entities.Gender');
    })(Northwind = Nydus_Suporte.Northwind || (Nydus_Suporte.Northwind = {}));
})(Nydus_Suporte || (Nydus_Suporte = {}));
var Nydus_Suporte;
(function (Nydus_Suporte) {
...
(function (Nydus_Suporte) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'Nydus_Suporte.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = Nydus_Suporte.Northwind || (Nydus_Suporte.Northwind = {}));
})(Nydus_Suporte || (Nydus_Suporte = {}));
var Nydus_Suporte;
(function (Nydus_Suporte) {
...
(function (Nydus_Suporte) {
    ...
    Nydus_Suporte.BasicProgressDialog = BasicProgressDialog;
})(Nydus_Suporte || (Nydus_Suporte = {}));
var Nydus_Suporte;
(function (Nydus_Suporte) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Nydus_Suporte.BasicProgressDialog();
...
(function (Nydus_Suporte) {
    ...
    })(DialogUtils = Nydus_Suporte.DialogUtils || (Nydus_Suporte.DialogUtils = {}));
})(Nydus_Suporte || (Nydus_Suporte = {}));
var Nydus_Suporte;
(function (Nydus_Suporte) {
    var Common;
...
(function (Nydus_Suporte) {
    ...
    Nydus_Suporte.StaticTextBlock = StaticTextBlock;
})(Nydus_Suporte || (Nydus_Suporte = {}));
var Nydus_Suporte;
(function (Nydus_Suporte) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Nydus_Suporte.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(Nydus_Suporte.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(Nydus_Suporte.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Nydus_Suporte.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Nydus_Suporte.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Nydus_Suporte.Authorization.userDefinition.DisplayName,
...
(function (Nydus_Suporte) {
    ...
    (function (Northwind) {
        ...
        }(Nydus_Suporte.Common.GridEditorDialog));
...
(function (Nydus_Suporte) {
    ...
    (function (Northwind) {
        ...
        }(Nydus_Suporte.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return Nydus_Suporte.LanguageList.getValue();
            };
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        }(Nydus_Suporte.Northwind.ProductDialog));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        }(Nydus_Suporte.Northwind.ProductGrid));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Nydus_Suporte.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Nydus_Suporte.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Nydus_Suporte.Northwind.OrderDialog();
                        ...
                        var chai = Nydus_Suporte.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Nydus_Suporte.Northwind.EmployeeRow.getLookup().items
        ...
        }(Nydus_Suporte.Northwind.OrderGrid));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        }(Nydus_Suporte.Northwind.OrderDialog));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Nydus_Suporte.Northwind.CategoryService.Retrieve({
        ...
        }(Nydus_Suporte.Northwind.CategoryDialog));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        }(Nydus_Suporte.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Nydus_Suporte.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Nydus_Suporte.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Nydus_Suporte.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Nydus_Suporte.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Nydus_Suporte.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Nydus_Suporte.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Nydus_Suporte.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Nydus_Suporte.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Nydus_Suporte.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Nydus_Suporte.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Nydus_Suporte.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Nydus_Suporte.Northwind.OrderService.baseUrl; };
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        }(Nydus_Suporte.Northwind.SupplierDialog));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Nydus_Suporte.Northwind.SupplierGrid));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Nydus_Suporte.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Nydus_Suporte.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Nydus_Suporte.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Nydus_Suporte.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Nydus_Suporte.Northwind.OrderService.baseUrl; };
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Nydus_Suporte.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Nydus_Suporte.Northwind.CustomerDialog));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        }(Nydus_Suporte.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = Nydus_Suporte.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Nydus_Suporte.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Nydus_Suporte.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Nydus_Suporte.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(Nydus_Suporte.Northwind.OrderDetailDialog));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        }(Nydus_Suporte.Northwind.OrderDetailsEditor));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Nydus_Suporte.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Nydus_Suporte.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Nydus_Suporte.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Nydus_Suporte.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Nydus_Suporte.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        ...
        }(Nydus_Suporte.Common.BulkServiceAction));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Nydus_Suporte.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Nydus_Suporte.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Nydus_Suporte.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Nydus_Suporte.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Nydus_Suporte.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Nydus_Suporte.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Nydus_Suporte.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Nydus_Suporte.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Nydus_Suporte) {
    ...
    Nydus_Suporte.SelectableEntityGrid = SelectableEntityGrid;
})(Nydus_Suporte || (Nydus_Suporte = {}));
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Nydus_Suporte.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Nydus_Suporte.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Nydus_Suporte.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Nydus_Suporte.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Nydus_Suporte.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Nydus_Suporte.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Nydus_Suporte.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Nydus_Suporte.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Nydus_Suporte.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Nydus_Suporte.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Nydus_Suporte.Northwind.ProductService.baseUrl; };
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Nydus_Suporte.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Nydus_Suporte.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Nydus_Suporte.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Nydus_Suporte.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Nydus_Suporte.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Nydus_Suporte.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Nydus_Suporte) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Nydus_Suporte.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Nydus_Suporte.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Nydus_Suporte.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=Nydus_Suporte.Web.js.map